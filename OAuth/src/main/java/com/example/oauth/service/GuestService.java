...
public class GuestService {
    ...
    public TokenRequest login(LoginRequest loginRequest){
        ...
        if(userRefreshToken == null){
            userRefreshToken = new UserRefreshToken(userId, refreshToken, jwtProperties.getRefreshTokenExp());
            userRefreshTokenRepository.save(userRefreshToken);
        } else {
            userRefreshToken.reissue(refreshToken, jwtProperties.getRefreshTokenExp());
        }
